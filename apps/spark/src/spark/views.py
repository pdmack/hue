...
from spark.management.commands import pig_setup
...
def stop(request):
  ...
  pig_script = SparkScript.objects.get(id=request.POST.get('id'))
...
def copy(request):
  ...
  script_copy = SparkScript.objects.create(owner=owner)
...
def delete(request):
  ...
  for script_id in ids:
    try:
      pig_script = SparkScript.objects.get(id=script_id)
