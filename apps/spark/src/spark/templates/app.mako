      ...
      <div class="sidebar-nav" style="padding-top: 0">
          <ul class="nav nav-list">
            ...
            <li data-bind="click: editScript" class="active" data-section="edit">
              <a href="#"><i class="fa fa-edit"></i> ${ _('Scala') }</a>
            </li>
            <li data-bind="click: editScript" data-section="edit">
              <a href="#"><i class="fa fa-edit"></i> ${ _('Java') }</a>
            </li>
            <li data-bind="click: editScript" data-section="edit">
              <a href="#"><i class="fa fa-edit"></i> ${ _('Python') }</a>
            </li>
